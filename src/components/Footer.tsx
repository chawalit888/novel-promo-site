      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-bold text-lg">
                <span className="text-gradient-rose">Novel</span>
                <span className="text-white/90">Promo</span>
              </span>
            </div>
            <p className="text-white/40 text-sm leading-relaxed max-w-xs">
              เว็บไซต์รวมนิยายออนไลน์ อ่านตัวอย่างฟรี ติดตามนิยายรักโรแมนติก Dark Romance ที่คุณชื่นชอบ
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-white/20 text-xs">
            Made with love for novel readers
          </p>
        </div>
      </div>
    </footer>
